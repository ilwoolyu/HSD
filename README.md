...
$ HSD \
      ...
      --icosahedron 7
```
>*Note*: We can also create and use spherical harmonics coefficients for each resolution `s1.coff.txt`, `s2.coff.txt`, `s3.coff.txt` rather than create deformed spheres. This will save storage and time for file writing.
